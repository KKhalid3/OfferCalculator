...
var $sort = (collection, sortKeys, options) => {
  if (isEmpty(sortKeys) || !isObject2(sortKeys))
    return collection;
  let cmp = compare;
...
function $eq(a, b, options) {
  ...
  if (a instanceof Array) {
    ...
    return a.some(eq) || flatten(a, options == null ? void 0 : options.depth).some(eq);
  }
  return false;
}
...
function validateExpression(expr, options) {
  ...
  for (const [k, v] of Object.entries(expr)) {
    if (k === (options == null ? void 0 : options.idKey))
      return;
    if (v === 0 || v === false) {
      check[0] = true;
    } else if (v === 1 || v === true) {
...
//# sourceMappingURL=chunk-OWKSHLMY.js.map
