import {
  ...
  unique,
  walk
} from "./chunk-R4NCRPPM.js";
import {
  __export
} from "./chunk-DC5AMYBS.js";

// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/query/index.js
var query_exports = {};
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/query/bitwise/_internal.js
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/query/bitwise/bitsAllClear.js
var $bitsAllClear = createBitwiseOperator((result, _) => result == 0);

// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/query/bitwise/bitsAllSet.js
var $bitsAllSet = createBitwiseOperator(
  (result, mask) => result == mask
);

// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/query/bitwise/bitsAnyClear.js
var $bitsAnyClear = createBitwiseOperator(
  (result, mask) => result < mask
);

// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/query/bitwise/bitsAnySet.js
var $bitsAnySet = createBitwiseOperator((result, _) => result > 0);

// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/index.js
var update_exports = {};
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/_internal.js
var clone2 = (mode, val) => {
  switch (mode) {
    case "deep":
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/addToSet.js
var $addToSet = (obj, expr, arrayFilters = [], options = {}) => {
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/bit.js
var BIT_OPS = /* @__PURE__ */ new Set(["and", "or", "xor"]);
var $bit = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/currentDate.js
var $currentDate = (obj, expr, arrayFilters = [], options = {}) => {
  const now = Date.now();
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/inc.js
var $inc = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
    if (!node.child) {
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/max.js
var $max = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
    return applyUpdate(
      obj,
      node,
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/min.js
var $min = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
    return applyUpdate(
      obj,
      node,
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/mul.js
var $mul = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
    return applyUpdate(
      obj,
      node,
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/pop.js
var $pop = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/pull.js
var $pull = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/pullAll.js
var $pullAll = (obj, expr, arrayFilters = [], options = {}) => {
  const pullExpr = {};
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/push.js
...
var $push = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
    const args = {
      $each: [val]
    };
    ...
    return applyUpdate(
      ...
      (o, k) => {
        ...
        arr.splice(
          pos,
          0,
          ...clone2(options.cloneMode, args.$each)
        );
        if (args.$sort) {
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/set.js
var $set = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (val, node, queries) => {
    return applyUpdate(
      obj,
      node,
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/rename.js
var $rename = (obj, expr, arrayFilters = [], options = {}) => {
  const res = [];
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/operators/update/unset.js
var $unset = (obj, expr, arrayFilters = [], options = {}) => {
  return walkExpression(expr, arrayFilters, options, (_, node, queries) => {
    return applyUpdate(obj, node, queries, (o, k) => {
      if (!has(o, k))
        return false;
...
// node_modules/.pnpm/mingo@6.4.15/node_modules/mingo/dist/esm/updater.js
function createUpdater(defaultOptions) {
  defaultOptions = {
    ...defaultOptions,
    queryOptions: initOptions(defaultOptions.queryOptions)
  };
  defaultOptions.queryOptions.context.addQueryOps(query_exports).addExpressionOps(boolean_exports).addExpressionOps(comparison_exports);
  return (obj, expr, arrayFilters = [], condition = {}, options = {}) => {
    ...
    Object.assign(opts, {
      queryOptions: initOptions(
        Object.assign({ useStrictMode: false }, opts == null ? void 0 : opts.queryOptions)
      )
    });
...
// node_modules/.pnpm/rxdb@15.39.0_rxjs@7.8.2/node_modules/rxdb/dist/esm/plugins/update/mingo-updater.js
var updater;
function mingoUpdater(d, op) {
  if (!updater) {
    var updateObject2 = createUpdater({
      cloneMode: "none"
    });
    updater = (d2, op2) => {
      var cloned = clone(d2);
      updateObject2(cloned, op2);
      return cloned;
    };
  }
  return updater(d, op);
...
// node_modules/.pnpm/rxdb@15.39.0_rxjs@7.8.2/node_modules/rxdb/dist/esm/plugins/update/index.js
